...
public class HeartModel implements HeartModelInterface, Runnable {
  ...
  /**
   * Método modificado: Devuelve el número de intentos de instanciación.
   */
  ...
  /**
   * Método creado: Devuelve la única instancia HeartModel. Si no existe la
   * crea. Si ya existe suma 1 a intentos.
   */
