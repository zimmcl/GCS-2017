...
public class Licencia {
  ...
  private void initialize() {
    ...
    springLayout.putConstraint(SpringLayout.NORTH, panel, 0, SpringLayout.NORTH,
        frmIntroducirClaveDe.getContentPane());
    springLayout.putConstraint(SpringLayout.WEST, panel, 0, SpringLayout.WEST,
        frmIntroducirClaveDe.getContentPane());
    springLayout.putConstraint(SpringLayout.SOUTH, panel, 246, SpringLayout.NORTH,
        frmIntroducirClaveDe.getContentPane());
    ...
    sl_panel.putConstraint(SpringLayout.NORTH, txtpnClaveActivadaCon, 6, SpringLayout.SOUTH,
        textField_1);
    ...
    sl_panel.putConstraint(SpringLayout.NORTH, txtpnClaveNoValida, 6, SpringLayout.SOUTH,
        textField_1);
